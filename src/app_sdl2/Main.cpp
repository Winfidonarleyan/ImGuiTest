...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("Dear ImGui SDL2 + OpenGL3 example", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, GENERAL_WINDOW_WIDTH, GENERAL_WINDOW_HEIGHT, window_flags);
...
#endif
    {
        ...
        if (showPlotWindow)
            ImPlot::ShowDemoWindow(&showPlotWindow);
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::Checkbox("Демо с графиками", &showPlotWindow);
